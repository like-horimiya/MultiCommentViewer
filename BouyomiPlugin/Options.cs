...
namespace BouyomiPlugin
{
    class Options : DynamicOptionsBase
    {
        ...
        protected override void Init()
        {
            ...
            Dict.Add(nameof(TwitchMaxEmotes), new Item { DefaultValue = 3, Predicate = n => n >= 0, Serializer = n => n.ToString(), Deserializer = s => int.Parse(s) });
            Dict.Add(nameof(IsTwitchSkipSameEmote), new Item { DefaultValue = false, Predicate = b => true, Serializer = b => b.ToString(), Deserializer = s => bool.Parse(s) });
